...
//   }
  ...
  function altRows(id){
	if(document.getElementsByTagName){  
		...
		var table = document.getElementByClassName(id);  
...
hear
   ...
   <!--here-->
    <div id="get-started" style="background:url(<?php echo $piclink['link'];?>) no-repeat;background-size:100% 100%">
...
<?php
  if($id_admin==1)
  {
    echo "</br><div class='admin' id='tab2'><center>";
    echo "</br>";
	...
	echo "</br>";
    echo "<span>Go to <a href='http://www.facebook.com/media/set/?set=a.156741824497103.1073741830.149169471921005&type=3' target='_blank'>Header Album</a> As Administrator to upload Photo</span><br/><br/>";
